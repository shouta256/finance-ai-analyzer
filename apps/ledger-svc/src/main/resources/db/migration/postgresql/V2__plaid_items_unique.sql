...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE plaid_items ADD CONSTRAINT plaid_items_item_unique UNIQUE (item_id);
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE plaid_items ADD CONSTRAINT plaid_items_user_item_unique UNIQUE (user_id, item_id);
    END IF;
END $$;
